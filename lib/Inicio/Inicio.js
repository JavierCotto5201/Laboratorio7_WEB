...
require("../Inicio/Inicio.scss");

require("../../node_modules/bootstrap/dist/js/bootstrap.js");

var link_inicio = document.createElement('div');
link_inicio.id = "links";
var titulo_inicio = document.createElement("h2");
titulo_inicio.id = "titulo_inicio";
titulo_inicio.innerText = "MI MEJOR ANIO: 2019";
link_inicio.appendChild(titulo_inicio);
var intro_inicio = document.createElement("h3");
...
var lista_inicio = document.createElement("ol");
lista_inicio.id = "lista_inicio";
link_inicio.appendChild(lista_inicio);
var l1_inicio = document.createElement("li");
var a1_inicio = document.createElement("a");
...
var l2_inicio = document.createElement("li");
var a2_inicio = document.createElement("a");
...
var l3_inicio = document.createElement("li");
var a3_inicio = document.createElement("a");
...
var l4_inicio = document.createElement("li");
var a4_inicio = document.createElement("a");
...
var l5_inicio = document.createElement("li");
var a5_inicio = document.createElement("a");
...
var l6_inicio = document.createElement("li");
var a6_inicio = document.createElement("a");
...
var l7_inicio = document.createElement("li");
var a7_inicio = document.createElement("a");
...
var l8_inicio = document.createElement("li");
var a8_inicio = document.createElement("a");
...
var l9_inicio = document.createElement("li");
var a9_inicio = document.createElement("a");
a9_inicio.href = "Ohana.html";
a9_inicio.innerText = "Ma Family";
l9_inicio.appendChild(a9_inicio);
lista_inicio.appendChild(l9_inicio);
var l10_inicio = document.createElement("li");
var a10_inicio = document.createElement("a");
...
var lista1_inicio = document.createElement("ul");
lista1_inicio.id = "lista1_inicio";
link_inicio.appendChild(lista1_inicio);
var l11_inicio = document.createElement("li");
var a11_inicio = document.createElement("a");
