...
var _buki = _interopRequireDefault(require("../imagenes/buki.mp4"));
...
video.id = "vidBuki";
video.src = _buki["default"];
video.width = "450";
video.autoplay = true;
vid.appendChild(video);
var p3_buki = document.createElement("p");
...
var lista_buki = document.createElement("ul");
vid.appendChild(lista_buki);
var l1_buki = document.createElement("li");
var a1_buki = document.createElement("a");
...
var label_buki = document.createElement("label");
label_buki.id = "pagina";
label_buki.innerText = "Pagina 8  \t";
var progress_buki = document.createElement("progress");
