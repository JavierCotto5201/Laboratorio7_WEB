...
var _benito = _interopRequireDefault(require("../imagenes/benito.mp4"));

require("../css/paginaV.scss");
...
video.id = "vidBunny";
video.src = _benito["default"];
video.width = "300";
video.autoplay = true;
vid.appendChild(video);
var p3_Bunny = document.createElement("p");
...
var lista_Bunny = document.createElement("ul");
vid.appendChild(lista_Bunny);
var l1_Bunny = document.createElement("li");
var a1_Bunny = document.createElement("a");
...
var label_Bunny = document.createElement("label");
label_Bunny.id = "pagina";
label_Bunny.innerText = "Pagina 5  \t";
var progress_Bunny = document.createElement("progress");
